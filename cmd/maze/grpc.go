...
import (
	...
	mazesvr "genmaze/gen/grpc/maze/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, mazeEndpoints *maze.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		mazeServer = mazesvr.New(mazeEndpoints, nil)
	}
	...
	mazepb.RegisterMazeServer(srv, mazeServer)
